...
if(!empty($_POST)){
	...
	define("IS_POST", true);
	$_POST = str_replace(array('<','>', '"', "'"),array('&lt;','&gt;', '&quot;', ''), $_POST);	// 防止 服务端攻击
}
...
/* 微信小程序相关设置  */
define('HS_APPID'  , 'wxfc0972e7c63b431e');
define('HS_SECRET' , 'db591c6eb5d091e8928d8a5e0e2f5881');
...
/* 路由解析 */
$_GET['c'] = empty($_GET['c']) ? 'index' : $_GET['c'];		// controller
$_GET['m'] = empty($_GET['m']) ? 'index' : $_GET['m'];		// methods
